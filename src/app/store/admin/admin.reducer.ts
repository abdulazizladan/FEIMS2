...
export const adminReducer = createReducer(
    ...
    on(addBuildingSuccess, (state, {building}) => ({...state, loading: false, buildings: [...state.buildings, building]})),
    on(addBuildingFail, (state, {reason}) => ({...state, loading: false, errors: [reason, ...state.errors]})),
